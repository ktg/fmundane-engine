      ...
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _loop = /*#__PURE__*/_regenerator["default"].mark(function _loop() {
            var actionlist, _alist;
            return _regenerator["default"].wrap(function _loop$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                case 0:
                  actionlist = _step2.value;
                  //swap in any params
                  _alist = actionlist.map(function (a) {
  ...
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(lines) {
    ...
    return _regenerator["default"].wrap(function _callee5$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          placeholders = _args6.length > 1 && _args6[1] !== undefined ? _args6[1] : {};
                ...
                return _regenerator["default"].wrap(function _callee8$(_context9) {
                  while (1) switch (_context9.prev = _context9.next) {
                    ...
                    case 17:
                      ...
                      _context9.next = 21;
                      return _context9.t0.all.call(_context9.t0, _context9.t3);
                    case 21:
                      (0, _ws.send)("ready", {
                        layer: config.id,
                        event: {
